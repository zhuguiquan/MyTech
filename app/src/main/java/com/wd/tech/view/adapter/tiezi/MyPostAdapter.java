package com.wd.tech.view.adapter.tiezi;
...
public class MyPostAdapter extends RecyclerView.Adapter<MyPostAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (resultBean.getFile()==""){
            ...
            NetUtil.getInstance().getPhoto(resultBean.getFile(),holder.postImage);
        }
        //删除
      holder.postCal.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              if (onRecyclerItemClickListener != null) {
                  onRecyclerItemClickListener.onItemClick(resultBean.getId()+"");
              }
          }
      });
    }
