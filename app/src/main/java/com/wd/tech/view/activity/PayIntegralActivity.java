...
import com.wd.tech.bean.ByIntegralBean;
    ...
    protected void initView() {
        ...
        integralBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mPresenter.postDoParams(MyUrls.CONSULT_INTEGRAL, ByIntegralBean.class, hashMap);
            }
        });
    }
    ...
    public void onSuccess(Object o) {
        if (o instanceof ConsultParticularsBean && TextUtils.equals("0000", ((ConsultParticularsBean) o).getStatus())) {
            ...
            if (result.getWhetherCollection() == 1) {
                integralCollectionImage.setImageResource(R.drawable.dianzan_hong);
            } else {
                integralCollectionImage.setImageResource(R.drawable.dianzan_hei);
            }
        ...
        if (o instanceof ByIntegralBean) {
            if (TextUtils.equals("0000", ((ByIntegralBean) o).getStatus())) {
                ...
                integralJixu.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(PayIntegralActivity.this, DetailActivity.class);
